...
test('User creates a new Ethereum account after onboarding', async ({
  ...
  const ethereumAccountTimer = new TimerHelper(
    'Time since the moment the user clicks on Create Ethereum account until account is created',
  );
  ethereumAccountTimer.start();
  await WalletMainScreen.clickOnMainScreen();
  await WalletMainScreen.isMainWalletViewVisible();
  ethereumAccountTimer.stop();
  const performanceTracker = new PerformanceTracker();
  performanceTracker.addTimer(ethereumAccountTimer);
